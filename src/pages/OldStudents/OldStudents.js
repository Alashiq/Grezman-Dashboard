...
is_solvedSrh:'',
    ...
    methods: {
        ...
        loadData: function (page) {
            ...
            this.$http
                .GetAllOldStudents(this.pageId, this.countPerPage
                    ,this.indexSrh,this.std_numberSrh,this.first_nameSrh,this.family_nameSrh,this.graduation_yearSrh,this.is_solvedSrh
                )
                .then(response => {
...
this.is_solvedSrh='',
        ...
        deleteMainItem: function (id) {
            Swal.fire({
                title: "هل أنت متأكد",
                text: "هل أنت متأكد من أنك تريد حذف هذا الطالب_قديم !",
                icon: "warning",
                    ...
                    this.$http
                        ...
                        .then(response => {
                            ...
                            if (response.status == 200) {
                                ...
                                this.mainList.splice(this.mainList.findIndex(m => m.id === id), 1);
                                this.$alert.Empty(
                                    "لم يعد هذا الطالب_قديم متوفر, قد يكون شخص أخر قام بحذفه"
                                );
                            }
