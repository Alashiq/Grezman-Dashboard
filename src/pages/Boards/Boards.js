...
adminSrh:'',
    ...
    methods: {
        ...
        loadData: function (page) {
            ...
            this.$http
                .GetAllBoards(this.pageId, this.countPerPage
                    ,this.is_activeSrh,this.levelSrh,this.collegeSrh,this.departmentSrh,this.adminSrh
                )
                .then(response => {
...
this.adminSrh='',
        ...
        deleteMainItem: function (id) {
            Swal.fire({
                title: "هل أنت متأكد",
                text: "هل أنت متأكد من أنك تريد حذف هذا الإعلان !",
                icon: "warning",
                    ...
                    this.$http
                        ...
                        .then(response => {
                            ...
                            if (response.status == 200) {
                                ...
                                this.mainList.splice(this.mainList.findIndex(m => m.id === id), 1);
                                this.$alert.Empty(
                                    "لم يعد هذا الإعلان متوفر, قد يكون شخص أخر قام بحذفه"
                                );
                            }
