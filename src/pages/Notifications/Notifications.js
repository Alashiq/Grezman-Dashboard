...
is_sentSrh:'',
    ...
    methods: {
        ...
        loadData: function (page) {
            ...
            this.$http
                .GetAllNotifications(this.pageId, this.countPerPage
                    ,this.typeSrh,this.student_idSrh,this.section_idSrh,this.department_idSrh,this.college_idSrh,this.is_sentSrh
                )
                .then(response => {
                    ...
                    this.$http
                        ...
                        .then(response => {
                            ...
                            if (response.status == 200) {
                                ...
                                this.mainList.splice(this.mainList.findIndex(m => m.id === id), 1);
                                this.$alert.Empty(
                                    "لم يعد هذا الإشعار متوفر, قد يكون شخص أخر قام بحذفه"
                                );
                            }
