...
is_activeSrh:'',
    ...
    methods: {
        ...
        loadData: function (page) {
            ...
            this.$http
                .GetAllCalendars(this.pageId, this.countPerPage
                    ,this.nameSrh,this.typeSrh,this.season_idSrh,this.is_activeSrh
                )
                .then(response => {
...
this.is_activeSrh='',
        ...
        deleteMainItem: function (id) {
            Swal.fire({
                title: "هل أنت متأكد",
                text: "هل أنت متأكد من أنك تريد حذف هذا التقويم !",
                icon: "warning",
                    ...
                    this.$http
                        ...
                        .then(response => {
                            ...
                            if (response.status == 200) {
                                ...
                                this.mainList.splice(this.mainList.findIndex(m => m.id === id), 1);
                                this.$alert.Empty(
                                    "لم يعد هذا التقويم متوفر, قد يكون شخص أخر قام بحذفه"
                                );
                            }
