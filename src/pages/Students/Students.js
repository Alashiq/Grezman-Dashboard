...
export default {
    ...
    methods: {
        ...
        loadData: function (page) {
            ...
            this.$http
                .GetAllStudents(this.pageId, this.countPerPage
                    , this.usernameSrh, this.emailSrh, this.phoneSrh, this.std_numberSrh, this.first_nameSrh, this.family_nameSrh, this.faculty_idSrh, this.department_idSrh
                )
                .then(response => {
                    ...
                    this.$http
                        ...
                        .then(response => {
                            ...
                            if (response.status == 200) {
                                ...
                                this.mainList.splice(this.mainList.findIndex(m => m.id === id), 1);
                                this.$alert.Empty(
                                    "لم يعد هذا الطالب متوفر, قد يكون شخص أخر قام بحذفه"
                                );
                            }
