...
reset_passwordSrh:'',
    ...
    methods: {
        ...
        loadData: function (page) {
            ...
            this.$http
                .GetAllEmails(this.pageId, this.countPerPage
                    ,this.user_idSrh,this.emailSrh,this.is_createdSrh,this.reset_passwordSrh
                )
                .then(response => {
...
this.reset_passwordSrh='',
        ...
        deleteMainItem: function (id) {
            Swal.fire({
                title: "هل أنت متأكد",
                text: "هل أنت متأكد من أنك تريد حذف هذا البريد_إلكتروني !",
                icon: "warning",
                    ...
                    this.$http
                        ...
                        .then(response => {
                            ...
                            if (response.status == 200) {
                                ...
                                this.mainList.splice(this.mainList.findIndex(m => m.id === id), 1);
                                this.$alert.Empty(
                                    "لم يعد هذا البريد_إلكتروني متوفر, قد يكون شخص أخر قام بحذفه"
                                );
                            }
